class Solution:
    def gameOfLife(self, board: List[List[int]]) -> None:
        ...
        #  when the value needs to be updated, we do not just change  0 to 1 / 1 to 0 but
        # we do in increments and decrements of 2. (table explains)
